...
<body background="<?= config::base_url('assets/img/webb-dark.png'); ?>">
	<?php if (preg_match("/bantuan/", ($_GET['ref'] ?? ''))) : ?>
		<ul class="menuheader">
			<div class="container">
				...
				<?php endif; ?>
				<li><a href="<?php if ($_SESSION['RAPORT']['level'] == "admin") {
										echo config::base_url('admin/index.php');
									} elseif ($_SESSION['RAPORT']['level'] == "guru") {
										echo config::base_url('guru/index.php');
