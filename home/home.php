...
<div class="conHomeFront <?php if (($_GET['harusLogin'] ?? '') == 'yes') echo 'defaultAfterAnimateHide'; ?>">
	...
	<div class="homeFront homeFrontSilver cf">
		...
		<form id="form">
			...
			<a href="<?= config::base_url('admin/login/login.php'); ?>" class="button green marginTop20px marginBottom100px">Login Sebagai Kepala Sekolah</a>
		</form>
	</div>
	...
	<p class="copyRight marginTop20px">Copyright &copy; <?= date('Y'); ?> Deddy Prianto Sihombing. All Rights Reserved</p>
</div>
