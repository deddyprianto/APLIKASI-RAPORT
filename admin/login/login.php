...
<body background="<?= config::base_url('assets/img/5-dots.png'); ?>">
	<!-- progress bar -->
	...
	<div class="loginAdmin">
		<form action="proses.php" id="form" method="post">
			<div class="login_top">
				...
				<a href="<?= config::base_url(); ?>" class="button green marginTop20px">Kembali Ke beranda</a>
			</div><!-- login_top -->
			<p class="copyRight marginTop20px">Copyright &copy; <?= date('Y'); ?> Deddy Prianto. All Rights Reserved</p>
		</form>
	</div>
